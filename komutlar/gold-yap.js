...
exports.run = async (bot, message, args) => {
 ...
 message.client.channels.get('711846852198400002').send(`<a:kirmizi:690267037745807431> \`${nesne}\` ID'li Kullanıcı Gold Üyeliğe Eklendi <a:kirmizi:690267037745807431>`)
