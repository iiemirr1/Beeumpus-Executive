...
.setThumbnail(client.user.avatarURL)
      .addField('** Yetkili [13]**', '`terfi`, `ban`,`unban`,`kick`, `emojiler`, `yaz`, `sil`, `ping`, `rol-bilgi`, `oylama`, `hatırlat`,`süreliban`,`temizle-üye`,`çekiliş`,`kanalkilit`,`rolal`,`rolver`,`yavaşmod`')
      ...
      .addField('** Kullanıcı [11]**', '`avatar`, `sunucubilgi`, `ping`, `havadurumu`,`top5`,`yasaklar`,`üyedurum`,`döviz`,`değişiklikler`,`saat`,`youtube`,`servericon`,`say`,`hesapla`,`korona`,`kısalt`,`kanalbilgi`,`istatistik`,`banner`,`canlıdestek`')
      .addField('** Koruma Sistemleri [11]**', '`rolkoruma`, `güvenlik`,`self-koruma`,`ddos-sistemi`')
