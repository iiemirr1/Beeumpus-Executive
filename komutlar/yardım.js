...
.setThumbnail(client.user.avatarURL)
      .addField('** Yetkili [14]**', '`terfi`, `ban`,`unban`,`kick`, `emojiler`, `dm-hg`, `yaz`, `sil`, `ping`, `rol-bilgi`, `oylama`, `hatırlat`,`süreliban`,`temizle-üye`,`çekiliş`,`kayıt-sistemi`')
      .addField('** **', '`terfi`, `ban`,`unban`,`kick`, `emojiler`, `dm-hg`, `yaz`, `sil`, `ping`, `rol-bilgi`, `oylama`, `hatırlat`,`süreliban`,`temizle-üye`,`çekiliş`,`kayıt-sistemi`')
